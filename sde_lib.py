...
class SDE(abc.ABC):
    ...
    @abc.abstractmethod
    def sde(self, x, t):
        """Return the drift & diffusion of SDE."""
        pass
    ...
    def reverse(self, score_fn, probability_flow=False):
        ...
        Args:
          ...
          probability_flow: If `True`, create the reverse-time ODE used for probability flow sampling. Default: False.
        ...
        class RSDE(self.__class__):
            ...
            def sde(self, x, t):
                ...
                # reverse-sde: $f(x,t) - G^2(t) * s$; ode: $f(x,t) - \frac{1}{2} G^2(t) * s$
            ...
            def discretize(self, x, t):
                ...
                # sde: $[f(x,t) - G^2(t) * s] \Delta t$; ode: $[f(x,t) - \frac{1}{2} G^2(t) * s] \Delta t$
...
class subVPSDE(SDE):
    ...
    def sde(self, x, t):
        ...
        beta_t = self.beta_0 + t * (self.beta_1 - self.beta_0)
        drift = -0.5 * beta_t[:, None, None, None] * x
        # 将 $\beta(t) = \beta_0 + t(\beta_1 - \beta_0)$ 代入式(12)中计算自然底数的幂部分
...
class VESDE(SDE):
    ...
    def prior_sampling(self, shape):
        """Sampling from prior: \mathcal N(0, sigma_max I)"""
